...
import { ChevronDown, GitBranch, Layers, Mic, Paperclip, Settings } from "lucide-react";
            ...
            <div className="flex flex-col justify-between h-[11rem] br-background dark:bg-secondary rounded-3xl border border-border p-2">
              ...
              <div className="flex justify-between items-center gap-2">
                <div className="flex items-center gap-2">
                  <Button size="sm" variant="secondary" className="bg-input/30 shadow-none rounded-xl">
                  ...
                  <SelectSearchButton
                      ...
                      buttonIcon={<Settings className="size-4 mr-1 shrink-0" strokeWidth={1} />}
                  ...
                  <div className="flex items-center">
                    <Select defaultValue="1x">
                      ...
                      <SelectContent className="rounded-2xl ">
                        <SelectItem value="1x" className="rounded-lg">1x</SelectItem>
                        <SelectItem value="2x" className="rounded-lg">2x</SelectItem>
                        <SelectItem value="3x" className="rounded-lg">3x</SelectItem>
                        <SelectItem value="4x" className="rounded-lg">4x</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
